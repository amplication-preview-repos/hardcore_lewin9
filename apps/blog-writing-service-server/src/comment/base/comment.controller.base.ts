...
export class CommentControllerBase {
  ...
  async CreateCommentMutation(
    @common.Body()
    body: string
  ): Promise<Comment> {
    return this.service.CreateCommentMutation(body);
  }

  @common.Get("/:id/get-comments-by-post-id")
  @swagger.ApiOkResponse({
    type: String,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async GetCommentsByPostId(
    ...
    return this.service.GetCommentsByPostId(body);
  }

  @common.Get("/post/:postId")
  @swagger.ApiOkResponse({
    type: Comment,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async GetCommentsByPostIdQuery(
    @common.Body()
    body: string
  ): Promise<Comment[]> {
    return this.service.GetCommentsByPostIdQuery(body);
  }
}
