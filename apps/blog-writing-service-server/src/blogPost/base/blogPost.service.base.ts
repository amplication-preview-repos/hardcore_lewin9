...
export class BlogPostServiceBase {
  ...
  async CreateBlogPostMutation(args: CreateBlogPostArgs): Promise<BlogPost> {
    throw new Error("Not implemented");
  }
  async GetBlogPostById(args: string): Promise<string> {
    throw new Error("Not implemented");
  }
  async GetBlogPostByIdQuery(args: BlogPostFindUniqueArgs): Promise<BlogPost> {
    throw new Error("Not implemented");
  }
}
